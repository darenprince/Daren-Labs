...
export type ProductCategory = "Intelligence" | "Security" | "Forensics" | "Creative" | "Relationship" | "Cultural" | "Frameworks";
...
export const products: Product[] = [
  {
    ...
    description: "A multimodal AI intelligence suite that documents, correlates, profiles, forecasts, and explains evidence-grade insights.",
  ...
  },
  {
    ...
    description: "A browser-based security camera platform that turns any device into an intelligent, real-time surveillance system.",
  ...
  },
  {
    ...
    description: "A real-time emergency response and proof-of-life platform with live location, audio, and evidence capture.",
  ...
  },
  {
    ...
    description: "Transforms a single image into a structured intelligence artifact with forensic reporting.",
  ...
  },
  {
    ...
    description: "Analyzes rhythm, pacing, and emotional flow to remove AI residue while preserving the author's voice.",
  ...
  },
  {
    ...
    category: "Creative",
    categoryLabel: "Creative, Communication & Behavioral Systems",
    description: "A daily generative insight engine grounded in psychology, emotional regulation, and agency.",
  ...
  },
  {
    ...
    category: "Security",
    categoryLabel: "Forensic & Analytical Systems",
    description: "Deep visibility into network traffic, wireless signals, and environmental indicators for real-time anomaly detection.",
  ...
  },
  {
    ...
    category: "Creative",
    categoryLabel: "Creative, Communication & Behavioral Systems",
    description: "An emotionally intelligent marketing engine blending psychology, narrative structure, and data-driven insight.",
  ...
  },
  {
    ...
    description: "A strategic system for cultivating attraction, authority, and emotional gravity without chasing attention.",
  ...
  },
  {
    ...
    category: "Relationship",
    categoryLabel: "Relationship & Cultural Products",
    description: "A playful, guided platform for couples to build connection without therapy language or pressure.",
  ...
  },
  {
    ...
    category: "Cultural",
    categoryLabel: "Relationship & Cultural Products",
    description: "A culturally sharp consumer tech concept blending satire, behavioral insight, and tracking tech.",
...
export function getStatusColor(status: ProductStatus): string {
  switch (status) {
    case "Stage 1 Beta": return "text-red-400 bg-red-950/50 border-red-800/50";
    case "Beta": return "text-amber-400 bg-amber-950/50 border-amber-800/50";
    case "Prototype": return "text-blue-400 bg-blue-950/50 border-blue-800/50";
    case "Concept": return "text-zinc-400 bg-zinc-900/50 border-zinc-700/50";
    case "Live": return "text-green-400 bg-green-950/50 border-green-800/50";
    default: return "text-zinc-400 bg-zinc-900/50 border-zinc-700/50";
  }
}

export function getCategoryColor(category: ProductCategory): string {
  switch (category) {
    case "Intelligence": return "text-violet-400 bg-violet-950/50 border-violet-800/50";
    case "Security": return "text-blue-400 bg-blue-950/50 border-blue-800/50";
    case "Forensics": return "text-amber-400 bg-amber-950/50 border-amber-800/50";
    case "Creative": return "text-pink-400 bg-pink-950/50 border-pink-800/50";
    case "Relationship": return "text-rose-400 bg-rose-950/50 border-rose-800/50";
    case "Cultural": return "text-orange-400 bg-orange-950/50 border-orange-800/50";
    case "Frameworks": return "text-teal-400 bg-teal-950/50 border-teal-800/50";
    default: return "text-zinc-400 bg-zinc-900/50 border-zinc-700/50";
  }
}
