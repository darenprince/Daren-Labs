      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="rounded-xl border border-border bg-card overflow-hidden">
          <div className="grid grid-cols-3 px-5 py-3 border-b border-border">
            ...
            <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">What it means</p>
            <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Next gate</p>
          </div>
          {statuses.map((s, i) => (
            <div
              key={i}
            ...
            >
              <div>
                <span className={`inline-flex px-2 py-0.5 rounded text-xs font-semibold ${s.bg} ${s.color} border border-current/20`}>
                  {s.label}
                </span>
              </div>
