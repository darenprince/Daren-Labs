        ...
        <form onSubmit={handleSubmit} className="space-y-6 pt-4">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="da-name" name="name" placeholder="Ada Lovelace" className="border-border bg-background" />
              {errors.name && <p className="text-xs text-destructive">{errors.name}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="da-email">Email address *</Label>
              <Input id="da-email" name="email" type="email" placeholder="ada@example.com" className="border-border bg-background" />
              {errors.email && <p className="text-xs text-destructive">{errors.email}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="da-url">GitHub or Portfolio URL *</Label>
              <Input id="da-url" name="url" placeholder="https://github.com/..." className="border-border bg-background" />
            ...
            <div className="space-y-2">
              ...
              <Textarea id="da-about" name="about" placeholder="What are you building? What drives you?" className="border-border bg-background min-h-[100px]" />
            ...
            <div className="flex items-center space-x-2 pt-2">
              ...
              />
              <Label htmlFor="da-available" className="text-sm font-normal cursor-pointer">I'm available for contract or full-time work</Label>
            </div>
          </div>
