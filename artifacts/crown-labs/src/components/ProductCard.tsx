              ...
              <div className="mt-4 space-y-4 border-t border-border pt-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {product.metrics.map((metric, i) => (
                    <div key={i} className="text-center rounded-lg border border-border bg-background/40 p-3">
                ...
                <div ref={progressRef}>
                  <div className="flex justify-between items-end mb-1.5">
                    <p className="text-[10px] text-muted-foreground uppercase tracking-widest">Readiness score</p>
