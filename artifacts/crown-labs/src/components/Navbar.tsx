              ...
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 px-3 py-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors">
                  {user.profileImageUrl ? (
                    <img src={user.profileImageUrl} alt={displayName ?? ""} className="h-5 w-5 rounded-full object-cover" />
                  ) : (
          ...
          <>
            ...
            >
              ...
              {!isLoading && (
                isAuthenticated && user ? (
                  <>
                    <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }} className="flex items-center gap-3 py-2 border-t border-border mt-1 pt-3">
                      {user.profileImageUrl ? (
                    ...
                    <motion.button initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} onClick={logout} className="flex items-center gap-2 py-2 text-sm text-muted-foreground">
                      <LogOut className="h-4 w-4" /> Log out
                    </motion.button>
                  </>
                ) : (
                  <motion.button initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }} onClick={login} className="flex items-center gap-2 py-2 text-sm text-muted-foreground">
