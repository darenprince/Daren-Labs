  ...
  return (
    <section className="py-20 px-4 sm:px-6 border-t border-border">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Portfolio Valuation & Net Worth Statement</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <div className="rounded-xl border border-border bg-card p-6 space-y-4">
            ...
            <p className="text-xs text-muted-foreground">Current valuation reflects active development status.</p>
          </div>

          <div className="rounded-xl border border-primary/20 bg-primary/5 p-6 space-y-4">
            <div className="flex items-center gap-3">
              <TrendingUp className="h-5 w-5 text-primary" />
              <h3 className="text-sm font-semibold text-foreground">Projected valuation (completed)</h3>
            </div>
            <div className="space-y-1">
              <div className="flex items-center justify-between">
                <span className="text-xs text-muted-foreground">Low estimate</span>
            ...
            <p className="text-xs text-muted-foreground">Completion unlocks enterprise, licensing, and acquisition pathways.</p>
          </div>
