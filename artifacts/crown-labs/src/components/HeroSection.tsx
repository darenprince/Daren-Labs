              ...
              <div className="p-5 space-y-5">
                ...
                <div className="rounded-lg border border-border bg-background/50 p-4 space-y-4">
                  <div>
                    ...
                    <p className="text-sm font-semibold text-foreground">{flagship.readiness?.stage}</p>
                  </div>
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-muted-foreground mb-1">Focus</p>
                    <p className="text-sm font-semibold text-foreground">{flagship.readiness?.focus}</p>
                  </div>
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-muted-foreground mb-1">Next Gate</p>
                    <p className="text-sm font-semibold text-foreground">{flagship.readiness?.nextGate}</p>
                  </div>
                </div>
